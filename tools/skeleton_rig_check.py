...
and the entity template for the authored leg parameters:
    ...
    python3 tools/skeleton_rig_check.py \
        --manifest=bazel-bin/game_server/skeleton_assets/generated/simplified_tripod.skeleton_manifest.json \
        --template=game_server/entity_templates/tripod_actor.yaml
